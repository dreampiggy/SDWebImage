...
typedef NS_OPTIONS(NSUInteger, SDWebImageOptions) {
     ...
     * @note This is used to treate placeholder as an **Error Placeholder** but not **Loading Placeholder** by defaults. if the image loading is error, the placeholder will be always set.
     * @note If the image loading is cancelled, the placeholder will be ignored as well.
     */
